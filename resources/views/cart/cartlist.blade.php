                ...
                <li>
                    ...
                    <div class="u-Cart-r">
                        ...
                        <div class="num-opt">
                            ...
                            <input class="text_box" goods_id="{{$v->goods_id}}" goods_num="{{$v->goods_num}}" buy_number="{{$v->buy_number}}" name="num" type="text" value="{{$v->buy_number}}">
                            <em class="num-add add"><i></i></em>
                        </div>
                        <a href="javascript:;" name="delLink" isover="0" class="z-del"><s></s></a>
                    </div>
                </li>
               @endforeach
            </ul>
