	...
	<div class="marginB" id="loadingPicBlock">
				...
				<ul class="slides" style="width: 600%; transition-duration: 0.4s; transform: translate3d(-828px, 0px, 0px);">
					<li style="width: 414px; float: left; display: block;" class="clone">
						<a href="http://weixin.1yyg.com/v27/products/23559.do?pf=weixin">
							<img src="{{url('images/messi.jpg')}}" alt="">
						</a>
					</li>
		...
		<div class="index-menu thin-bor-top thin-bor-bottom">
			<ul class="menu-list">
				...
				<li>
					<a href="{{url('goods/goodslist')}}?cate_id={{$v->cate_id}}" id="btnNew">
						<i class="xinpin"></i>
		...
		<div class="goods-wrap marginB">
			<ul id="ulGoodsList" class="goods-list clearfix">
				...
				<li  >
					<a href="{{url('goods/shopcontent')}}?goods_id={{$v->goods_id}}" class="g-pic">
						<img class="lazy" name="goodsImg" data-original="/goodsimg/{{$v->goods_img}}" width="136" height="136">
					</a>
					<a href="{{url('goods/shopcontent')}}?goods_id={{$v->goods_id}}"><p class="g-name">{{$v->goods_name}}</p></a>
					...
					<div class="btn-wrap" name="buyBox" limitbuy="0" surplus="58" totalnum="1625" alreadybuy="1567">
						...
						<div class="gRate"  codeid="12751965" canbuy="58">
							<a class="cart" goods_num="{{$v->goods_num}}"  goods_id="{{$v->goods_id}}" href="javascript:;"></a>
						</div>
					</div>
				</li>
				@endforeach
		...
		<div class="footer clearfix">
			<ul>
				<li class="f_home"><a href="{{url('/')}}" class="hover"><i></i>潮购</a></li> <!--class="hover"-->
		...
		<div id="div_fastnav" class="fast-nav-wrapper">
			...
			<div class="sub-nav four" style="display: none;">
				...
				<a href="{{url('cart/cartlist')}}"><i class="shopcar"></i>购物车</a>
			</div>
		</div>
	</div>
@endsection
