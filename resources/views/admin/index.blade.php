...
<head>
    ...
    <link rel="stylesheet" href="{{url('xadmin/css/font.css')}}">
	<link rel="stylesheet" href="{{url('xadmin/css/xadmin.css')}}">
    <script type="text/javascript" src="{{url('js/jquery-1.8.3.min.js')}}"></script>
    <script type="text/javascript"src="https://cdn.bootcss.com/blueimp-md5/2.10.0/js/md5.min.js"></script>
    <script src="{{url('xadmin/lib/layui/layui.js')}}" charset="utf-8"></script>
    <script src="{{url('xadmin/lib/layui/css/layui.css')}}" charset="utf-8"></script>
    <script type="text/javascript" src="{{url('xadmin/js/xadmin.js')}}"></script>
    <script type="text/javascript" src="{{url('xadmin/js/cookie.js')}}"></script>
    <script>
        // 是否开启刷新记忆tab功能
...
<body>
    <!-- 顶部开始 -->
    <div class="container">
        <div class="logo"><a href="./index.html">慕希</a></div>
        <div class="left_open">
      ...
      <div id="side-nav">
        <ul id="nav">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="{{url('admin/upform')}}">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>首次关注内容设置</cite>
                        </a>
                    </li>
                    <li>
                        <a _href="{{url('admin/wxtype')}}">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>首次关注类型设置</cite>
                        </a>
                    </li>
    ...
    <!-- 底部开始 -->
    <div class="footer">
        <div class="copyright">最终解释权归华展所有</div>
    </div>
    <!-- 底部结束 -->
    <script>
    //百度统计可去掉
