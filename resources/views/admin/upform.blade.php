...
<div style="margin-top: 40px;width: 600px;">
    <form action="{{url('admin/upformdo')}}" method="post" enctype="multipart/form-data" class="layui-form">
        @csrf
            ...
            form.on('select(aihao)', function(data){
                ...
                if(_type=='text'){
                    ...
                    var str='<div class="layui-form-item">\n' +
                        ...
                        '            <div class="layui-input-block">\n' +
                        '                <input type="text" name="des" required  lay-verify="required" placeholder="请输入简介" autocomplete="off" class="layui-input">\n' +
                        '            </div>\n' +
                        '        </div>\n' +
                        '        <div class="layui-form-item">\n' +
                        ...
                        '            <div class="layui-input-block">\n' +
                        '                <input type="text" name="url" required  lay-verify="required" placeholder="请输入网站链接" autocomplete="off" class="layui-input">\n' +
                        '            </div>\n' +
                        '        </div>';
                    $("#tbd").html(str);
                }else{
